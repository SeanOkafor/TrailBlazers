...
public class FinalBoss {
	...
	// ========== HEALTH ==========
	private static final int HP_PER_PHASE = 25000;
	private static final int TOTAL_PHASES = 3;
	private static final int TOTAL_MAX_HP = HP_PER_PHASE * TOTAL_PHASES;  // 75,000
	
	// Current phase (0 = phase 1, 1 = phase 2, 2 = phase 3)
	private int currentPhase = 0;
	
	// HP remaining in the CURRENT phase (starts at 25,000, drains to 0)
	private int phaseHp;
	
	// Total HP remaining across all phases (for health bar display)
	// Calculated as: (phases remaining after current * HP_PER_PHASE) + phaseHp
	private int totalHp;
